...
/***/ function(module, exports, __webpack_require__) {
	...
	const sweetalert = __webpack_require__(8);
	...
	document.addEventListener("DOMContentLoaded", function() {
	  ...
	  sweetalert({
	    ...
	    text: "Use arrow keys to move and spacebar to pause",
	    type: "warning",
...
/***/ function(module, exports, __webpack_require__) {
	...
	GameView.prototype.restartGame = function() {
	  if (this.game.gameOver) {
	    ...
	    sweetalert({
	      title: `You lasted ${this.game.secondsElapsed} seconds!`,
	      text: "Click below to start another game",
	      type: "warning",
	      showCancelButton: false,
	      confirmButtonColor: "#DD6B55",
	      confirmButtonText: "Start",
